...
namespace Duanmau.Web.API.Migrations
{
    ...
    [Migration("20240323145550_Initial3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Duanmau.Web.API.Models.DanhMucFood", b =>
                {
                    b.Property<int>("DanhMucFoodId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DanhMucFoodId"));

                    b.Property<string>("DanhMucFoodName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Mota")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("DanhMucFoodId");

                    b.ToTable("DanhMucFoods");
                });
            ...
            modelBuilder.Entity("Duanmau.Web.API.Models.Food", b =>
                {
                    b.HasOne("Duanmau.Web.API.Models.DanhMucFood", "DanhMucFoods")
                        .WithMany()
                        .HasForeignKey("DanhMucFoodId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("DanhMucFoods");
                });
